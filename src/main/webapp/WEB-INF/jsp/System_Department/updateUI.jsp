        ...
        <div class="ItemBlockBorder">
            <div class="ItemBlock">
                <table cellpadding="0" cellspacing="0" class="mainForm">
                    ...
                    <tr><td>部门名称</td>
                        <td><input type="text" name="dept.name" class="InputStyle" value="${deptt.name}"/> *</td>
                    </tr>
                    <input type="hidden" name="dept.did" value="${deptt.did}">
                    <tr><td>职能说明</td>
                        <td><textarea name="dept.description" class="TextareaStyle">${deptt.description}</textarea></td>
                    </tr>
                </table>
            </div>
        </div>
