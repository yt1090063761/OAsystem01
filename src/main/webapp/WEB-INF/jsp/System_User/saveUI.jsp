    ...
    $(document).ready(function(){
     ...
     $("#loginname").blur(function () {
         ...
         $.ajax({
             ...
             url : "user_checkloginname?user.loginname="+$("#loginname").val(),
            ...
            <div class="ItemBlock">
                <table cellpadding="0" cellspacing="0" class="mainForm">
                    <tr><td width="100">所属部门</td>
                        ...
                        <td><select id="depts" name="departmentId" class="SelectStyle">
                    ...
                    <tr><td>登录名</td>
                        <td><input type="text" id="loginname" name="user.loginName" class="InputStyle" /> *<span id="check"></span>
							（登录名要唯一）
						</td>
                    </tr>
                    <tr><td>姓名</td>
                        <td><input type="text" name="user.name" class="InputStyle"/> *</td>
                    </tr>
					<tr><td>性别</td>
					...
					<tr><td>联系电话</td>
                        <td><input type="text" name="user.phoneNumber" class="InputStyle"/></td>
                    </tr>
                    <tr><td>E-mail</td>
                        <td><input type="text" name="user.email" class="InputStyle"/></td>
                    </tr>
                    <tr><td>备注</td>
                        <td><textarea name="user.description" class="TextareaStyle"></textarea></td>
                    </tr>
                </table>
            </div>
        </div>
